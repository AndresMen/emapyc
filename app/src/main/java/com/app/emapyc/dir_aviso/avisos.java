...
public class avisos extends Fragment {
    ...
    //public String AVISO_USU=IP+"/aviso_usuario.php";
    public String avicodigo;
    ...
    public void cargar(){
        ...
        if (fila.moveToFirst()) {
            avicodigo= Constantes.AVISO_USU+"?usu_cod="+fila.getString(0);
            VolleySingleton.getInstance(getContext()).addToRequestQueue(
                    new JsonObjectRequest(
                            Request.Method.GET,avicodigo,new Response.Listener<JSONObject>() {
