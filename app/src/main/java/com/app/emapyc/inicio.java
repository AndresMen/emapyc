...
public class inicio extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tx=(TextView)view.findViewById(R.id.in);
        fila = bd.rawQuery(
                "select * from usuario where estado='activo'", null);
        if (fila.moveToFirst()) {
            tx.setText(getResources().getString(R.string.ini)+"\n\nSu información es: "+"\n\nCódigo: "+fila.getString(0)+"\nNombre: "+fila.getString(2)+"\nDireccion: "+fila.getString(3)+"\nMedidor: "+fila.getString(5));
        }
        return view;
    }
